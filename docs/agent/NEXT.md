...
[`Task 013`](tasks/013-recurring-schedules.md) has a final cache-rewind guard under
verification before merge. Its local canonical gate passed 478 tests; fresh
Linux CI remains before completion.
After this closes, establish the minimum task-status/approval experience
