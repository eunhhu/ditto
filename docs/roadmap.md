...
## I. Reliable scheduled work — one-shot and finite repeats implemented
...
gate, production smoke checks and Linux CI including the final cache-rewind
guard. Calendar cron, indefinite repetition,
